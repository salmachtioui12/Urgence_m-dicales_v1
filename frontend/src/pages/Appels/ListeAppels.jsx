...
export default function ListeAppels() {
  ...
  return (
    <div style={{ maxWidth: 1000, margin: "20px auto", fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" }}>
      <h2 style={{ textAlign: "center", marginBottom: 20, color: "#34495e",fontSize: "1.8rem" }}>Liste des Appels d'Urgence</h2>
...
export default function ListeAppels() {
  ...
  return (
    <div className="liste-appels-container">
      <h2 className="liste-appels-title">Liste des Appels d'Urgence</h2>
      ...
      <div className="liste-appels-cards">
        {appelsFiltres.length === 0 ? (
          <p className="no-appels">Aucun appel trouvé.</p>
        ) : (
          appelsFiltres.map((appel) => (
            <div
              key={appel._id}
            ...
            >
              ...
              <p className="appel-description">{appel.description}</p>

              <div className="appel-infos">
                <div><strong>Localisation:</strong> {appel.localisation}</div>
                <div><strong>Heure:</strong> {new Date(appel.heureAppel).toLocaleString()}</div>
                <div>
                  <strong>État:</strong>{" "}
                  <span
                    className="appel-etat"
                    style={{
                      color:
                        appel.etat === "en attente"
                          ? "#f39c12"
                ...
                <div><strong>Ambulance:</strong> {appel.ambulanceAffectee ?? "Aucune"}</div>
              </div>
            </div>
          ))
        )}
